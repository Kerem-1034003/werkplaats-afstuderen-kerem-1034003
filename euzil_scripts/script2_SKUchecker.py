...
supplier_products_file = '../excel/simpledeal/euzil/euzil.xlsx'  # Vervang door het bestand van de leverancier
output_file = '../excel/simpledeal/euzil/nieuwe_euzilproducten.xlsx'  # Uitvoerbestand voor nieuwe producten
