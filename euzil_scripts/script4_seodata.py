...
# Laad de DataFrame
df = pd.read_excel('../herschreven_excel/simpledeal/euzil/output_script3.xlsx', dtype={'meta:_alg_ean': str})
...
# Opslaan
output_file = '../herschreven_excel/simpledeal/euzil/output_script4.xlsx'
