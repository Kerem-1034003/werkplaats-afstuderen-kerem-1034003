...
# Laad de DataFrame
df = pd.read_excel('herschreven_excel/simpledeal/homcomproducten_2.1.xlsx', dtype={'meta:_alg_ean': str})
...
# Opslaan
output_file = 'herschreven_excel/simpledeal/homcomproducten_final_2.xlsx'
