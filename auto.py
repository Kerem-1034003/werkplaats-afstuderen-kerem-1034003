...
df = pd.read_excel('excel/autoinkoop/autoinkoop_split_final_4.xlsx')
...
df.to_excel('herschreven_excel/autoinkoop/herschreven_autoinkoop_split_final_4.xlsx', index=False)
