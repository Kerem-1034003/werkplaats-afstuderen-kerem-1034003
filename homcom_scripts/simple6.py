...
excel_file = '../herschreven_excel/simpledeal/homcomsplit/output_Bureaustoelen.xlsx'  # Het bestand van de producten
...
def fill_attribute_values(excel_file):
    ...
    output_file = '../herschreven_excel/simpledeal/homcomimport/updated_bureaustoelen.xlsx'
