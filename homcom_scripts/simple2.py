...
# Laad de DataFrame
df = pd.read_excel('../herschreven_excel/simpledeal/homcom/homcom2.xlsx', dtype={'meta:_alg_ean': str})
...
# Opslaan
output_file = '../herschreven_excel/simpledeal//homcom/homcom2.1.xlsx'
