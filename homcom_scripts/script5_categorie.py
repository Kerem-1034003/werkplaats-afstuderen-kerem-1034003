...
df = pd.read_excel('../herschreven_excel/simpledeal/homcom/output_script4.xlsx')
...
output_file = "../herschreven_excel/simpledeal/homcom/output_script5.xlsx"
...
wb.save("../herschreven_excel/simpledeal/homcom/output_script5.1.xlsx")
